...
- [realestatebr](https://cran.r-project.org/web/packages/realestatebr/index.html): Consolidates real estate data from different sources (Abecip, Abrainc, BCB, FipeZap, etc.)
